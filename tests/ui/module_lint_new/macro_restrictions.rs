...
// The proc_macro variants are demonstrated and CI'd as part of test_app.

//@compile-flags: --crate-name test_macro_restrictions
//@compile-flags: --crate-type lib

// Declarative macro - should trigger the declarative_macro lint
macro_rules! forbidden_declarative_macro { //~ ERROR: declarative macro 'forbidden_declarative_macro' is not allowed in this module
    () => {
...
macro_rules! another_forbidden_macro { //~ ERROR: declarative macro 'another_forbidden_macro' is not allowed in this module
    ($x:expr) => {
