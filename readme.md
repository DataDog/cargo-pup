...
validate consistency both locally and in your CI pipelines. Inspired by [ArchUnit](https://www.archunit.org/) and
[ArchUnitNet](https://github.com/TNG/ArchUnitNET), it also introduces an exciting, fresh naming convention for
architectural linting tools.

Pup lets you enforce your system’s architecture, reducing reliance on contributors to maintain consistency.
As projects grow, architectural consistency becomes harder to manage, and pup helps prevent the
cognitive load that comes with it.
